...
docker build -t $PROJECT/api-gateway -f api-gateway/Dockerfile api-gateway
...
docker build -t $PROJECT/learning-service -f learning-service/Dockerfile learning-service
...
docker build -t $PROJECT/assessment-service -f assessment-service/Dockerfile assessment-service
...
docker build -t $PROJECT/gamification-service -f gamification-service/Dockerfile gamification-service
...
docker build -t $PROJECT/api-docs -f api-docs/Dockerfile api-docs
