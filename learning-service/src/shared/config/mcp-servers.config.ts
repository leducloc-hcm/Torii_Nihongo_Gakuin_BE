...
export const MCP_SERVERS: Record<string, MCPServerConfig> = {
  course: {
    name: "course-mcp",
    url:
      process.env.MCP_COURSE_SERVER_URL || "http://localhost:8002/course/mcp",
  ...
  blog: {
    name: "blog-mcp",
    url: process.env.MCP_BLOG_SERVER_URL || "http://localhost:8002/blog/mcp",
  ...
  analytics: {
    ...
    description:
      "Multi-agent router, progress analytics, and personalized recommendations",
  },
};
