...
export type QuestionGroupTypeType =
  (typeof QuestionGroupType)[keyof typeof QuestionGroupType];
export type QuestionSubtypeType =
  (typeof QuestionSubtype)[keyof typeof QuestionSubtype];
...
export type OrderItemTypeType =
  (typeof OrderItemType)[keyof typeof OrderItemType];
...
export type ReadingLengthType =
  (typeof ReadingLength)[keyof typeof ReadingLength];
