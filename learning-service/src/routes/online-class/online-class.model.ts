...
export const ClassListQuerySchema = z.object({
  ...
  sortBy: z
    .enum(["createdAt", "scheduledAt", "title", "capacity"])
    .optional()
    .default("scheduledAt"),
...
export const ShareDocumentSchema = z.object({
  ...
  description: z.string().optional(),
  type: z
    .enum(["pdf", "image", "presentation", "video", "other"])
    .optional()
    .default("other"),
...
export const ScreenShareStartSchema = z.object({
  ...
  frameRate: z
    ...
    .int()
    .min(5, "Minimum 5 fps")
    .max(30, "Maximum 30 fps")
    .optional()
    .default(15),
  maxBitrate: z
    .number()
    .int()
    .min(100000, "Minimum 100kbps")
    .max(2000000, "Maximum 2Mbps")
    .optional()
    .default(512000),
});
...
export const RaiseHandRequestSchema = z.object({
  ...
  priority: z
    ...
    .default("normal"),
  category: z
    .enum(["technical", "content", "audio", "video", "other"])
    .optional()
    .default("other"),
});
...
export const BreakoutRoomSchema = z.object({
  ...
  roomCount: z
    .number()
    .int()
    .min(2, "Minimum 2 rooms")
    .max(10, "Maximum 10 rooms")
    .optional(),
