...
import { ClassFolderController } from './class-folder.controller'
...
@Module({
  ...
  controllers: [OnlineClassController, ClassFolderController],
  providers: [OnlineClassService, ClassFolderService],
  exports: [OnlineClassService, ClassFolderService],
})
