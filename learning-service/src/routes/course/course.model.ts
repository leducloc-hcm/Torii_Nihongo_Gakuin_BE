...
export const CourseSchema = z.object({
  ...
  courseType: z
    .enum(["VIDEO_QUIZ", "VIDEO_QUIZ_LIVE", "LIVE_ONLY"])
    .default("VIDEO_QUIZ"),
...
export const QueryCourseSchema = z.object({
  ...
  status: z
    ...
    .optional(),
  sortBy: z
    .enum(["createdAt", "title", "price", "level"])
    .optional()
    .default("createdAt"),
...
export type PublishedCourseListItemType = z.infer<
  typeof PublishedCourseListItemSchema
>;
export type UpdateCourseStatusTypeForAdmin = z.infer<
  typeof UpdateCourseStatusSchemaForAdmin
>;
