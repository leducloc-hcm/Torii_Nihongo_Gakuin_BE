...
export class FlashcardController {
  ...
  @Roles(RoleName.Customer, RoleName.Lecturer)
  async getStudyCards(
    @Query() query: GetStudyCardsQueryDto,
    @ActiveUser("userId") userId: number,
  ) {
  ...
  @Auth([AuthType.Bearer])
  @Roles(RoleName.Customer, RoleName.Lecturer)
  async submitStudyResponse(
    @Body() responseDto: StudyResponseDto,
    @ActiveUser("userId") userId: number,
  ) {
  ...
  async submitBulkStudyResponse(
    @Body() bulkResponseDto: BulkStudyResponseDto,
    @ActiveUser("userId") userId: number,
  ) {
    return await this.flashcardService.submitBulkStudyResponse(
      userId,
      bulkResponseDto,
    );
  }
  ...
  @IsPublic()
  @HttpCode(HttpStatus.OK)
  async generateFlashcards(@Body() body: GenerateFlashcardsDto) {
