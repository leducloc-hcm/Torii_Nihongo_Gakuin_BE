...
export class PaymentController {
  ...
  @HttpCode(HttpStatus.OK)
  getOrdersSummary() {
    return this.paymentService.getOrdersSummary();
  }
  ...
  async createSepayPayment(
    ...
    return this.paymentService.createSepayPaymentWithCoupon(
      userId,
  ...
  async buyCourseDirectWithSepay(
    ...
    return await this.paymentService.buyCourseDirectWithCoupon(
      userId,
      buyDto.courseId,
      buyDto.couponCode,
    );
  ...
  async sepayWebhook(@Body() webhookData: SepayWebhookDTO) {
    ...
    try {
      const res = await axios.post(
        `${assessmentBaseUrl}/payments/sepay/webhook`,
        webhookData,
        {
          timeout: 5000,
  ...
  async getFailedPayments(
    ...
    return this.paymentService.getFailedPayments(userId, {
      page: page || 1,
      limit: limit || 10,
    });
  }
