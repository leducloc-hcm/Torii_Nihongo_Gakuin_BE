...
import { CouponType, CouponStatus, RedemptionStatus, CouponWhereInput, CouponWithRelations } from './coupon.model'
...
export class CouponRepository {
  ...
  async linkCourses(couponId: number, courses: Array<{ courseId: number; required: boolean }>) {
