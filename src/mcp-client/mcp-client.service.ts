...
import { FastMCPResult, MCPExecuteRequest, MCPTool } from 'src/mcp-client/mcp.model'
...
export class McpBaseService {
  ...
  async executeTool(serverUrl: string, toolName: string, args: Record<string, any>): Promise<FastMCPResult> {
    try {
