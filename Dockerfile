...
ENV DATABASE_URL="postgresql://postgres:nhatngutorii@db.rkizlomnljifkbdimrup.supabase.co:5432/postgres?schema=public"
...
ENV RESEND_API_KEY='re_EdkMPA6w_DDaFN1DVV83USR4fKeg9wPJ1'
