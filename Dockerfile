...
ENV DATABASE_URL="postgresql://postgres.rkizlomnljifkbdimrup:nhatngutorii@aws-0-ap-southeast-1.pooler.supabase.com:6543/postgres?pgbouncer=true&schema=public"
